...
(() => {
  ...
  const setValues = (action) => { // This might be initialization 
    ...
    if (seek) {
      ...
      spsSeekButtonLeft.style.display = 'flex';
      spsSeekButtonRight.style.display = 'flex';
    } else {
  ...
  const addHTML = () => {
    ...
    spsSeekButtonLeft.innerHTML = '<svg text-anchor="middle" width="20" viewBox="-2 0 20 20" height="20" style="position: absolute;" class="Svg-sc-ytk21e-0 haNxPq"><text class="sps-seek-txt" x="4" y="18">10</text></svg><svg role="img" height="20" width="20" aria-hidden="true" viewBox="-2 -2 20 20" data-encore-id="icon" class="Svg-sc-ytk21e-0 haNxPq" preserveAspectRatio="xMaxYMax meet"><g transform="scale(-1, 1) translate(-16,0)"><path d="M13.536 4.5h-1.473a.75.75 0 1 0 0 1.5H16V2.063a.75.75 0 0 0-1.5 0v1.27A8.25 8.25 0 1 0 3.962 15.887a.75.75 0 1 0 .827-1.25A6.75 6.75 0 1 1 13.535 4.5z"></path></g></svg>';
    spsSeekButtonRight.innerHTML = '<svg text-anchor="middle" width="20" viewBox="-2 0 20 20" height="20" style="position: absolute;" class="Svg-sc-ytk21e-0 haNxPq"><text class="sps-seek-txt" x="12" y="18">10</text></svg><svg role="img" height="20" width="20" aria-hidden="true" viewBox="-2 -2 20 20" data-encore-id="icon" class="Svg-sc-ytk21e-0 haNxPq" preserveAspectRatio="xMaxYMax meet"><g transform="translate(0,0)"><path d="M13.536 4.5h-1.473a.75.75 0 1 0 0 1.5H16V2.063a.75.75 0 0 0-1.5 0v1.27A8.25 8.25 0 1 0 3.962 15.887a.75.75 0 1 0 .827-1.25A6.75 6.75 0 1 1 13.535 4.5z"></path></g></svg>';
